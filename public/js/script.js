(function($) {
    ...
    if ($("#wish-form").length) {
        $("#wish-form").validate({
            ...
            messages: {
                name: {
                    required: '<span style="color:#fff;">Vui lòng nhập tên của bạn.</span>',
                    minlength: '<span style="color:#fff;">Tên phải lớn hơn 5 ký tự.</span>',
                },
                content: {
                    required: '<span style="color:#fff;">Vui lòng nhập lời chúc.</span>',
                    minlength: '<span style="color:#fff;">Lời chúc phải lớn hơn 10 ký tự.</span>',
                },
                email: {
                    email: '<span style="color:#fff;">Địa chỉ email không hợp lệ.</span>'
                }
            },
